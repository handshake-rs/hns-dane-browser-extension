...
- `extension/`: Manifest V3 service worker, options/popup UI, generated desktop dependency notices, packaging tests, and user-level native-host/CA installers.
